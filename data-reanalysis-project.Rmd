...
To assess in more detail where these differences in the duration and number of calls are situated between the four predator condtions, the authors conducted Wilcoxon Rank Tests.
```{r}
library(coin)
